...
const Login = () => {
  ...
  return (
    <>
      <div className="h-[100vh] w-full flex flex-col justify-center bg-gradient-to-r from-[#29A6E0] to-[#2E3494] ">
        <div className=" sm:min-w-[30rem] mx-auto bg-white shadow-2xl rounded-2xl p-10 ">
          ...
          >
            ...
            <Button
              type="submit"
              variant="filled"
              className="primary-gradient black text-white py-2 font-bold text-md mt-4 rounded-md flex items-center justify-center bg-gradient-to-r from-[#29A6E0] to-[#2E3494]"
              loading={isLoading}
            >
              Log In
            </Button>
        ...
        <div className="primary-gradient h-2 md:h-5"></div>
      </div>
    </>
  );
};
